...
import { Checkbox, Empty, Input, Pagination, Skeleton } from "antd";
import {
  FilterFilled,
    ...
    <div className="py-10">
      <div className="my-container space-y-8">
        ...
        {isProductsLoading ? (
          ...
          <div className="py-4 flex flex-wrap justify-between items-center bg-slate-50 p-2 rounded gap-4">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            ...
            ) : products?.meta?.total === 0 || products?.data?.length === 0 ? (
